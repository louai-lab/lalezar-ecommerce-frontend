    ...
    <>
      <article className={Styles.blogsContainer}>
        <main className={Styles.blogsMain}>
          <Link to={`/blogs/${latestBlog.slug}`} className={Styles.linkStyles}>
            <figure className={Styles.blogsHero}>
              ...
              <div className={Styles.blogsTitleContainer}>
                ...
                <h1 className={Styles.blogsTitle}>
                  {latestBlog ? (
                    language === "en" ? (
                      latestBlog.title_en || "Title not available"
                    ) : (
                      latestBlog.title_ar || "العنوان غير متوفر"
                    )
                  ) : (
                    <div className={Styles.containerLoading}>
                      <div className={Styles.loadingIndicator}></div>
                ...
                <div className={Styles.continueContainer}>
                  ...
                  <span className={Styles.continueButton}>
                    {language === "en" ? "Continue reading" : "استمر بالقراءة"}
                  </span>
                </div>
              </div>
            </figure>
